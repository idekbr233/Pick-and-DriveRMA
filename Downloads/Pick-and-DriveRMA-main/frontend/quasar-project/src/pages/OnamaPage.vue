<template>
  <q-page class="q-pa-none" style="background-color: #211c1c;">
    <q-img
      ...
      fit="cover"
    />
    <div class="q-pa-lg q-mt-none" style="color: white;" >
      <h1>Naša misija</h1>
      <p>
        Naša misija je pružiti pouzdanu, jednostavnu i pristupačnu uslugu najma vozila
        za privatne i poslovne korisnike. Kontinuirano ulažemo u kvalitetu vozila,
        digitalna rješenja i korisničku podršku kako bismo osigurali ugodno iskustvo
        svakom klijentu.
      </p>
      ...
      <h2>Kontakt i poslovnice</h2>
        ...
        <p class="q-mb-xl">
          ...
          <strong>Poslovnica Zagreb: </strong> zagreb@autonajam.hr <br>
